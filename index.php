...
<body>
            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <div class="col-md-4 text-light">
                        <h1 class="display-5" style="color: black">Banyak kursus menarik</h1>
                        <p class="lead" style="color: black">Ambil kursusnya sekarang</p>
                    </div>

                    <div class="col-md-6">
                        <form class="form-inline my-2 my-lg-0">
                            <input class="form-control form-control-lg mr-sm-0 col-8
                                 border-right-0 " style="border-radius: 5px 0px 0px 5px; " type="search" placeholder="Sedang ingin belajar apa?" aria-label="Search">

                            <button class="btn btn-light btn-lg my-2 my-sm-0 col-2 border-left-0" style="border-radius: 0px 5px 5px 0px;" type="submit"><i class="fas text-danger fa-search"></i></button>
                        </form>
                    </div>
    ...
    <div class="fresh-content text-light py-3" style="width: 1349px; height: 85.7667px">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h5 class="mt-0 mb-0" style="font-size: 18px; font-weight: bold">Konten Baru</h5> Lebih dari 0 konten baru setiap bulannya
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="media">
                        ...
                        <div class="media-body mb-3">
                            <h5 class="mt-0 mb-0" style="font-size: 18px; font-weight: bold">Instruktur ahli</h5>
                            <p class="mb-0">Ambil kursus yang diadakan oleh instruktur ahli pada bidangnya</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h5 class="mt-0 mb-0" style="font-size: 18px; font-weight: bold">Pembelajaran Fleksibel</h5> Sistem belajar yang fleksibel dapat diakses kapanpun dan dimanapun
                        </div>
                    </div>
                </div>
            ...
            <form>
                <div class="form-group col-6 float-right">
                    <select class="form-control" id="exampleFormControlSelect2">
                        <option><i class="fas fa-globe"></i> Bahasa</option>
