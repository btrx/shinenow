          ...
          <ul class="navbar-nav mr-auto container-fluid">
            ...
            <li class="nav-item col-8">
                     <form class="form-inline my-2 my-lg-0 inbutton">
                            ...
                            type="search" placeholder="Cari apa?" aria-label="Search">
                  ...
                  <div class="col-md-6">
                        <form class="form-inline my-2 my-lg-0" >
                                <input class="form-control form-control-lg mr-sm-0 col-8
                                 border-right-0 "
                                style="border-radius: 5px 0px 0px 5px; " 
                                 type="search" placeholder="Sedang ingin belajar apa?" 
                                 aria-label="Search">
               ...
               <div class="row">
                   <div class="col-md-4">
                       <div class="media">
                            ...
                            <div class="media-body">
                              <h5 class="mt-0 mb-0" style="font-size: 18px; font-weight: bold">Konten Baru</h5>
                              Lebih dari 0 konten baru setiap bulannya
                            </div>
                          </div>
                   </div>
                   ...
                   <div class="col-md-4">
                        <div class="media">
                             ...
                             <div class="media-body">
                               <h5 class="mt-0 mb-0" style="font-size: 18px; font-weight: bold">Pembelajaran Fleksibel</h5>
                               Sistem belajar yang fleksibel dapat diakses kapanpun dan dimanapun
                             </div>
                           </div>
                    </div>
