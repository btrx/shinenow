...
elseif($_GET[module]=='tambah_soal'){
  include "sidebar.php";
  include "modul/mod_soal/tambah_soal.php";
}
...
elseif ($_GET[module]=='isimateri'){
  include "sidebar.php";  
  include "modul/mod_materi/isimateri.php";
}
elseif ($_GET[module]=='tambahmateri'){
  include "sidebar.php";  
  include "modul/mod_materi/isimateri.php";
}
elseif ($_GET[module]=='profiluser'){
  include "sidebar.php";  
