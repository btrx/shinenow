...
switch($_GET[act]) {
  ...
  echo "<div style='text-align:right;padding-right:30px;'>
    ...
    echo"<datalist id='auto'>";
     $qry=mysqli_query($con,"SELECT * FROM tbl_soal");
  ...
  //Tampil Data Soal    
    ...
    $topik = $_GET[topik];
    $tampil=mysqli_query($con,"SELECT * FROM tbl_soal WHERE topik = '$topik' ORDER BY id_soal DESC");
    //var_dump($topik);
    $no=1;
    ...
    echo "<h2>Tambah Soal</h2>
          <form method=POST class='form-horizontal' action='$aksi?module=soal&act=input' enctype='multipart/form-data'>
                       ...
                       <div class='form-group'>
                          ...
                          <div class='col-sm-4'>
                            <input type=text name='topik' value='$_GET[topik]' class='form-control' size=80 required/>
                          </div>
                        </div>
          ...
          <form method=POST class='form-horizontal' action='$aksi?module=soal&act=tambahmateri&id=$r[id]&topik=$_GET[topik]' enctype='multipart/form-data'>
                       ...
                       <div class='form-group'>
                        ...
                        <div class='form-group'>
                          ...
                          <div class='col-sm-5'>
                            <img src='../admin/modul/mod_soal/img/$r[cover]' width='100px'><br>
    ...
    echo "<h2>Edit Soal</h2>
          ...
          <input type=hidden name=id value='$r[id_soal]'>
                        <div class='form-group'>
                          <label for='inputEmail3' class='col-sm-2 control-label'></label>
                          <div class='col-sm-4'>
                            <input type=hidden name='topik' class='form-control' size=80 value='$r[topik]' required/>
                          </div>
                        </div>
  ...
  case "viewsoal":
    $view=mysqli_query($con,"SELECT * FROM tbl_soal WHERE id_soal='$_GET[id]'");
  ...
  case "carisoal":
    ...
    $tampil=mysqli_query($con,"SELECT * FROM tbl_soal WHERE soal LIKE '%$_POST[cari]%'");
    $no=1;
    while ($r=mysqli_fetch_array($tampil)){
       echo "<tr><td>$no</td>
             <td>$r[soal]</td>
