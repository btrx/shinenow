...
$result = mysqli_query($con, "SELECT * FROM t_soal ORDER BY id DESC");
// $cekisi = mysqli_query($con, "SELECT * FROM tbl_materi WHERE topik = '$r[topik]'");
// var_dump($cekisi);
...
echo "<h2> Daftar Materi</h2>
    ...
    while ($r=mysqli_fetch_array($result)){
       echo "<tr><td>$no</td>
             ...
             <td><a href='?module=soal&topik=$r[topik]'>Lihat</a> | <a href='modul/mod_soal/aksi_soal.php?module=soal&act=hapustopik&id=$r[id]&topik=$r[topik]'>Hapus</a></td>";
