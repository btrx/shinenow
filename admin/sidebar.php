        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img src="../images/logo.png" width="100px" style="margin-top: -15px;"></a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                         ...
                         <li>
                            <a href="?module=hasilujian"><i class="fa fa-file fa-fw"></i> Hasil Quiz</a>
                        </li>

                       <!--  <li>
                            <a href="?module=pengaturanujian"><i class="fa fa-gear fa-fw"></i></a>
                        </li> -->

                       <!--  <li>
                            <a href="?module=panduan"><i class="fa fa-book fa-fw"></i></a>
                        </li> -->
